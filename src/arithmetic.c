...
//                             //if the expression contains a number                      long k = 0;
//                             while (code[i] != ' ' && code[i] != ';' && code[i] != '\0' && isdigit(code[i])) {
//                                 valstr[k++] = code[i++];
//                             }
//                             valstr[k] = '\0';
...
//                                 //if there's a pending operation in the opstack                         op[0] = o[0];
//                                 op[1] = '\0';
//                                 val = perform_arithmetic(val,op,value);
//                                 o[0] = 'N';
//                             } 
...
//                             //If that expression contains a variable                            long k = 0;
//                             while (code[i] != ' ' && code[i] != ';' && code[i] != '\0' && isalpha(code[i])) {
//                                 probably_var[k++] = code[i++];
//                             }
//                             probably_var[k] = '\0';
//                             long num1 = get_variable_value(probably_var);
//                             while (code[i] == ' ') //will get the value of the variable{
//                                 i++;
//                             }
//                             if(o[0]=='N'){
//                                 val = num1;
...
//                         if(code[i]=='+'||code[i]=='-'||code[i]=='/'||code[i]=='*'||code[i]=='%'){
//                             if(code[i]=='*'&&code[i
//                             //to add an operation to the opstack+1]=='*'){
//                                 o[0]='*';
//                                 o[1]='*';
//                                 o[2]='\0';
//                                 i+=2;
